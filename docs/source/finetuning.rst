...
Although QLoRA need not work with NF4 specifically,
NF4 has been shown to achieve competitive results compared to
bf16 baselines while significantly reducing the memory required
for training. For a full example of how TorchTune incorporates the `NF4Tensor`
in its QLoRA fine-tuning recipe, see their implementation of
`LoRALinear <https://github.com/pytorch/torchtune/blob/a6290a5b40758f13bca61c386bc8756a49ef417e/torchtune/modules/peft/lora.py#L19>`__.
